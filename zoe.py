...
a=(int(253.6*10+86.3*60+96.8*43+135.9*63+65.8*63+49.3*120+86.3*72+253.6*69+86.3*35+253.6*140+86.3*90+135.9*24+65.8*45+96.8*25+86.3*60+65.8*128+253.6*10+96.8*43+65.8*63+86.3*60+135.9*63+96.8*60+65.8*58+86.3*140+65.8*48+96.8*43+135.9*57+253.6*10+65.8*63+96.8*78))
print('总销售额：',a)
b=(10+60+43+63+120+72+69+35+140+90+24+45+25+60+129+10+43+63+60+63+60+58+140+48+43+57+10+69+78)
c=(int(b/30))
print('平均每日销售数量：',c)
yrf=((10+69+140+10+10)/b)
nzk=((60+72+35+90+60+60+140)/b)
fy=((43+25+43+60+43+78)/b)
pc=((63+24+63+57)/b)
tx=((63+45+129+63+58+48+63)/b)
cs=120/b
print('羽绒服：',(format(yrf,'.2%')))
print('牛仔裤：',(format(nzk,'.2%')))
print('风衣：',(format(fy,'.2%')))
print('皮草：',(format(pc,'.2%')))
print('T恤：',(format(tx,'.2%')))
print('衬衫：',(format(cs,'.2%')))
